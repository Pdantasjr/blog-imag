<template>
    ...
    <div class="w-screen mt-4 bg-neutral">
        ...
        <div class="lg:max-w-7xl w-11/12 mx-auto my-2">
            <p class="text-[1rem] sm:text-[1.3rem] text-primary font-light text-justify leading-relaxed">A IMAG nasceu
                no ano de
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div class=" my-4 flex sm:flex-col lg:flex-row items-center justify-start">
                        ...
                        <div class="flex items-center w-11/12 sm:w-56 lg:w-64 h-full">
                            <p class="text-white font-light text-justify leading-tight mx-2 ">Prover uma solução em
                                saúde com caráter integral, centrada no cuidado individualizado ao paciente, baseada na
                                excelência de recursos humanos e robustez tecnológica.</p>
                        </div>
                    ...
                    <div class=" my-4 flex sm:flex-col lg:flex-row items-center justify-start">
                        ...
                        <div class="w-[2px] h-full bg-white/50 sm:hidden block"></div>
                        <div class="flex items-center w-11/12 sm:w-56 lg:w-64 h-full">
                            <p class="text-white font-light text-justify leading-tight mx-2 ">Ser uma referência
                                locorregional no segmento da saúde, com ênfase em medicina diagnóstica e preventiva.</p>
                        </div>
                        <div class="w-[2px] h-full bg-white/50 hidden lg:block"></div>
                    </div>
                    <div class=" my-4 flex sm:flex-col lg:flex-row items-center justify-start">
                        ...
                        <div class="w-[2px] h-full bg-white/50 sm:hidden block"></div>
                        <div class="flex items-center w-11/12 sm:w-56 lg:w-64 h-full">
                            <p class="text-white font-light text-justify leading-tight mx-2 ">A jornada do paciente deve
                                ser uma experiência personalista, conduzida por definições médicas assertivas, permeada
                                por um contexto de serenidade na percepção da assistência.</p>
                        </div>
                    </div>
                </div>
            </div>

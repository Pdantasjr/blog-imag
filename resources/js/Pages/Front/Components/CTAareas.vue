    ...
    <div class="w-screen">
        ...
        <div v-if="variant == 'top'"
            ...
            <Link
                ...
                <span
                    class="text-white text-[.8rem] xs:text-lg font-light ml-2 group-hover:font-bold">Área do Paciente</span>
            </Link>
            <Link
                class="flex justify-center items-center bg-primary w-3/4 h-8 rounded-full border border-white my-2 mx-2 xs:mx-4 py-1 px-1 drop-shadow-md hover:drop-shadow-lg group"
                ...
                <span
                    class="text-white text-[.8rem] xs:text-lg font-light ml-2 group-hover:font-bold">Área do Médico</span>
            </Link>
        </div>
        <!--BLUE-->
        <div v-if="variant == 'blue'"
            ...
            <div class="w-full xs:w-64 flex flex-row">
                <Link
                    ...
                    <span
                        class="text-white text-md xs:text-lg font-light ml-2 group-hover:font-bold">Área do Paciente</span>
                </Link>
            </div>
            <div class="w-full xs:w-64 flex flex-row">
                <Link
                    ...
                    <Icons name="medic-w"/>
                    <span
                        class="text-white text-md xs:text-lg font-light ml-2 group-hover:font-bold">Área do Médico</span>
                </Link>
            </div>
        </div>
        <!--FOOTER-->
        <div v-if="variant == 'footer'"
            ...
            <div class="w-full xs:w-64 flex flex-row">
                <Link
                    ...
                    <span
                        class="text-primary text-md xs:text-lg font-light ml-2 group-hover:font-bold">Área do Paciente</span>
                </Link>
            </div>
            <div class="w-full xs:w-64 flex flex-row">
                <Link
                    ...
                    <Icons name="medic-b"/>
                    <span
                        class="text-primary text-md xs:text-lg font-light ml-2 group-hover:font-bold">Área do Médico</span>
                </Link>
            </div>
        </div>
    </div>

                                ...
                                <div class="overflow-y-auto relative">
                                    <table class="w-full text-left divide-y table-auto">
                                        ...
                                        <tr>
                                            ...
                                            <th class="px-4 py-2">
                                                <span
                                                    class="text-sm font-bold text-gray-600 flex flex-row items-center justify-center">Logotipo</span>
                                            </th>
                                            <th class="px-4 py-2">
                                                <span
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="px-4 py-3 flex items-center justify-center ">
                                                    <span class="text-gray-600">{{ agreement.name }}</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="px-4 py-3 flex items-center justify-center">
                                            ...
                                            <td>
                                                <div class="px-4 py-3 justify-center flex flex-row">
                                                    <Link :href="route('agreement.edit', [agreement.id])"
                                                    ...
                                                    <button @click="submit(agreement.id, agreement.name)"

<template>
    ...
    <img v-else-if="name === 'whatsappFooter'" class="w-6 h-6" src="@/Pages/Blog/Images/whatsapp-icon-footer.svg" alt="icone para whatsapp">
    ...
    <img v-else-if="name === 'pin'" class="w-6 h-6" src="@/Pages/Blog/Images/pin-icon.svg" alt="icone para medico">
    <img v-else-if="name === 'phoneFooter'" class="w-6 h-6" src="@/Pages/Blog/Images/phone-icon-footer.svg" alt="icone para medico">
    <img v-else-if="name === 'instagramFooter'" class="w-6 h-6" src="@/Pages/Blog/Images/instagram-icon-white.svg" alt="icone para medico">
    <img v-else-if="name === 'facebookFooter'" class="w-6 h-6" src="@/Pages/Blog/Images/facebook-icon-white.svg" alt="icone para medico">
    <img v-else-if="name === 'linkedinFooter'" class="w-6 h-6" src="@/Pages/Blog/Images/linkedin-icon-white.svg" alt="icone para medico">
    <span v-else></span>
</template>

                                                ...
                                                <div class="grid gap-6 grid-cols-1 sm:grid-cols-2">
                                                    ...
                                                    <div class="col-span-1">
                                                        <div class="space-y-2">
                                                            <div class="flex items-center justify-between space-x-1">
                                                                <label class="inline-flex items-center space-x-3" for="diagnosticImage">
                                                                    <span class="text-sm font-medium leading-4 text-gray-700">
                                                                        Imagem
                                                                        <sup class="font-medium text-danger-700">*</sup>
                                                                    </span>
                                                    ...
                                                    <div class="col-span-2 ">
                                                        <div class="flex flex-wrap items-center gap-4 justify-start">
                                                            <Link :href="route('diagnostic.index')" class="inline-flex items-center justify-center font-medium tracking-tight rounded-lg focus:outline-none focus:ring-offset-2 focus:ring-2 focus:ring-inset bg-gray-400 hover:bg-primary-500 focus:bg-primary-700 focus:ring-offset-primary-700 h-9 px-4 text-white shadow focus:ring-white">
                                                                <span>Voltar</span>
                                                            </Link>
                                                            <button type="submit"
...
export default defineComponent({
    ...
    methods: {
        ...
        changeImage(e) {
            ...
            reader.onload = (e) => {
                this.imageMethod = e.target.result
            }
